                ...
                "properties": {
                    "markdown": {
                        ...
                        "description": (
                            ...
                            "(school AND date in SAME paragraph, university bolded, date italicized at end). "
                            "Paragraph 2 must be **Full Degree Name** (GPA) *Location* "
                            "(degree AND location in SAME paragraph; bold the ENTIRE degree string, "
                            "e.g., **M.S. Statistics** \u2014 NOT 'M.S. in **Statistics**' or 'Master of Science in **Statistics**'). "
                            "Do NOT split university/date or degree/location onto separate paragraphs "
                            "(four-paragraph form breaks the right-alignment CSS and doubles the vertical space). "
