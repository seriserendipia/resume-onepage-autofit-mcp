                ...
                "properties": {
                    "markdown": {
                        ...
                        "description": (
                            ...
                            "**bold** (OPTIONAL, visual only -- highlight target JD keywords, job title, "
                            "project name, or key metrics like **15%**; do NOT rely on bold for structure), "
                            "*italic at end of line* (dates/locations, auto right-aligned in PDF), "
                            "- bullets, [text](url). "
                            "STRUCTURE RULE: every Experience/Project/Education header is ONE line that ENDS "
                            "with an italic *date or location*. That trailing italic is what the renderer "
                            "right-aligns and uses to detect the entry line; bolding is cosmetic and may be "
                            "applied to any words (e.g. only the job title or a JD skill) or none. "
                            "Experience entry: Company \u00b7 Role \u00b7 Location *Date range* "
                            "(all one line ending with the italic date, NO dot before it), blank line, then - bullets. "
                            "Education entry: EXACTLY two paragraphs separated by ONE blank line. "
                            "Paragraph 1 must be University *Date range* "
                            "(school AND date in SAME paragraph, date italicized at end; bold optional). "
                            "Paragraph 2 must be Full Degree Name (GPA) *Location* "
                            "(degree AND location in SAME paragraph, location italicized at end; if you bold the "
                            "degree, bold the ENTIRE degree string, e.g. **M.S. Statistics** NOT 'M.S. in **Statistics**'). "
                            "Do NOT split university/date or degree/location onto separate paragraphs "
                            "(four-paragraph form breaks the right-alignment and doubles the vertical space). "
